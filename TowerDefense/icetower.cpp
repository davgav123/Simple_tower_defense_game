...
IceTower::IceTower(qreal x, qreal y) :Tower(x, y, 20, 100, EnemyType::FLYING_ENEMY)
{
...
void IceTower::paint(QPainter *painter, const QStyleOptionGraphicsItem *, QWidget *)
{
    // draw the radius of the tower
    //painter->drawEllipse(tower_center, m_radius, m_radius);
    // draw the tower
    QPixmap pixmap(":/images/ice.png");
